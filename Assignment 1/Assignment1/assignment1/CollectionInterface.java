...
public interface CollectionInterface {
	 ...
	 * @throws Exception
	 *      An Exception is thrown if adding the identifier creates a collection with over 20 elements.
	 **/
	 ...
	 * 		None.
	 * @postcondition
	 * 		The union of this collection with collection2 as a Collection object.
	 * @throws Exception	
	 * 		An Exception is thrown if the union of the two collections contains over 20 identifiers.
	 **/
	 ...
	 * 		None.
	 * @postcondition
	 * 		The symmetric difference of this collection with collection2 is returned as a Collection object.
	 * @throws Exception
	 * 		An Exception is thrown if the symmetric difference of the two collections contains over 20 identifiers.
	 **/
